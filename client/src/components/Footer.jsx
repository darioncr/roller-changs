...
const Footer = () => {
  return (
    <footer
      className="container mx-auto px-6 py-8 flex flex-col items-center text-center bg-gradient-to-b 
    from-orange-500 to-orange-400 shadow-md mt-12 md:mt-16"
      id="contacto"
    >
      <h1 className=" px-5 py-5 font-extrabold text-3xl uppercase text-white">
        Contacto
      </h1>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="text-3xl flex items-center gap-4 text-white">
          <a
            href="https://www.instagram.com/rollers_changs/"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/share/1ACKFboTnp/?mibextid=wwXIfr"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://www.tiktok.com/@rollerschangs?_t=ZM-8uUev4Sapvz&_r=1"
            target="_blank"
            rel="noopener noreferrer"
          >
